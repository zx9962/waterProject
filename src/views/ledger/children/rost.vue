    ...
    <div id='rost'>
      ...
      <div style="margin: 0px;"></div>
        ...
        <div class="rightBox">
          ...
          <div class="overview">
            <el-checkbox v-model="checked">概览</el-checkbox>
          </div>
          <div class="erCeng d-flex">
            <div class="er_left">
            ...
            <div class="er_right flex-1">
              <el-checkbox-group v-model="backstage.checkList">
                ...
                <el-checkbox label="滤芯寿命管理"></el-checkbox>
